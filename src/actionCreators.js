...
export const CHANGE_YEAR_RANGE  = 'CHANGE_YEAR_RANGE';
export const CHANGE_SHOW_ALL    = 'CHANGE_SHOW_ALL';
...
export function changeYearRange(range){
...
export function changeShowAll(showAll){
  return {
...
export function recogFormat() {
  const state = Store.getState();
  const line = state.yearLine;
  ...
  case "eto":
    ...
    const yearCandidate = Array.from(GengoYear.estimateByEto(line, range.from, range.to))
